import 'package:coiner/core/network/interceptors/refresh_dio_interceptor.dart';
...
class DioClient {
  ...
  DioClient(final Ref ref) {
    ...
    dio.interceptors.add(RefreshDioInterceptor(dio, ref.watch(authDioProvider), ref));
  }
